...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- Icons -->
        <link href="{{ asset('blog/css/materialdesignicons.min.css') }}" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="https://unicons.iconscout.com/release/v3.0.6/css/line.css">
        <!-- Main Css -->
        <link href="{{ asset('blog/css/style.css') }}" rel="stylesheet" type="text/css" id="theme-opt" />
        <link href="{{ asset('blog/css/colors/default.css') }}" rel="stylesheet" id="color-opt">
    ...
    <body>
                    ...
                    <ul class="navigation-menu nav-light">
                        ...
                        <li class="has-submenu parent-parent-menu-item">
                            ...
                            <ul class="submenu megamenu">
                                ...
                                <li>
                                    <ul>
                                        <li><a href="index-finance.html" class="sub-menu-item">Finance <i class="mdi mdi-star align-middle text-warning"></i></a></li>
                                        <li><a href="index-videocall.html" class="sub-menu-item">Video Conference <i class="mdi mdi-star align-middle text-warning"></i></a></li>
                                        <li><a href="index-it-solution-two.html" class="sub-menu-item">IT Solution Two <i class="mdi mdi-star align-middle text-warning"></i></a></li>
                                        <li><a href="index-freelancer.html" class="sub-menu-item">Freelance <i class="mdi mdi-star align-middle text-warning"></i></a></li>
                                        <li><a href="index-blockchain.html" class="sub-menu-item">Blockchain <i class="mdi mdi-star align-middle text-warning"></i></a></li>
                                        <li><a href="index-crypto-two.html" class="sub-menu-item">Cryptocurrency Two <i class="mdi mdi-star align-middle text-warning"></i></a></li>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-2 col-md-3 text-md-start text-center">
                                        <img src="{{ asset('blog/images/photo_of_profile.png') }}" class="avatar avatar-large rounded-circle shadow d-block mx-auto" alt="">
                                    </div><!--end col-->
    
                                    <div class="col-lg-10 col-md-9">
                                        <div class="row align-items-end">
                                            <div class="col-md-7 text-md-start text-center mt-4 mt-sm-0">
                                                <h3 class="title mb-0">Kévine NASSARA</h3>
                                                <small class="text-muted h6 me-2">Développeur web et mobile</small>
                                                <ul class="list-inline mb-0 mt-3">
                                                    <li class="list-inline-item me-2"><a href="javascript:void(0)" class="text-muted" title="Instagram"><i data-feather="instagram" class="fea icon-sm me-2"></i>vine_nas</a></li>
                                                    <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted" title="Linkedin"><i data-feather="linkedin" class="fea icon-sm me-2"></i>vine_nas</a></li>
                                                </ul>
                                            </div><!--end col-->
                ...
                <div class="row">
                            ...
                            <div class="widget mt-4 pt-2">
                                ...
                                <div class="progress-box mt-4">
                                    ...
                                    @foreach ($skills as $skill)
                                        <h6 class="title text-muted">{{ $skill->name }}</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative " style="width: {{ $skill->progression }}%;">
                                                <div class="progress-value d-block text-muted h6">{{ $skill->progression }}</div>
                                            </div>
                                        </div>
                                    @endforeach
                                </div><!--end process box-->
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="border-bottom pb-4">
                            <h5>Kévine NASSARA</h5>
                            <p class="text-muted mb-0">
                                I have started my career as a trainee and prove my self and achieve all the milestone with good guidance and reach up to the project manager. In this journey, I understand all the procedure which make me a good developer, team leader, and a project manager.
                            </p>
                        </div>
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <a href="javascript:void(0)" class="text-muted">vinenassara@mail.com</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <a href="javascript:void(0)" class="text-muted">Français</a>, <a href="javascript:void(0)" class="text-muted">English</a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <a href="javascript:void(0)" class="text-muted">http://vinenas.banelsems.com/</a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-muted mb-0">31 Juillet, 2000</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <a href="javascript:void(0)" class="text-muted">Ouidah, Bénin</a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <a href="javascript:void(0)" class="text-muted">(+229) 91003606 / 58343579</a>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 pt-2">
                                <a href="page-blog-grid.html" class="btn btn-primary">See More <i class="uil uil-angle-right-b align-middle"></i></a>
                            </div><!--end col-->
                        </div><!--end row-->
                    </div><!--end col-->
                </div><!--end row-->
        ...
        <!-- Icons -->
        <script src="{{ asset('blog/js/feather.min.js') }}"></script>
        <!-- Main Js -->
        <script src="{{ asset('blog/js/plugins.init.js') }}"></script><!--Note: All init js like tiny slider, counter, countdown, maintenance, lightbox, gallery, swiper slider, aos animation etc.-->
        <script src="{{ asset('blog/js/app.js') }}"></script><!--Note: All important javascript like page loader, menu, sticky menu, menu-toggler, one page menu etc. -->
    </body>
</html>