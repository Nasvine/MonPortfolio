<div class="sidebar-nav slimscrollsidebar">
    ...
    <ul class="nav" id="side-menu">
        <li> <a href="{{ route('admin') }}" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> Dashboard  </span></a></li>
        
        
        <li> <a href="#" class="waves-effect"><i class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">Skills & Experience<span class="fa arrow"></span> </span></a>
            
            <ul class="nav nav-second-level">
                <li> <a href="{{ route('skill.admin.index') }}" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe026;"></i> <span class="hide-menu"> Skills  </span></a></li>
                <li><a href="{{ route('experience.admin.index') }}"><i data-icon="&#xe025;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Experiences</span></a></li>
        ...
        <li> <a href="{{ route('formation.admin.index') }}" class="waves-effect"><i class="mdi mdi-content-copy fa-fw"></i> <span class="hide-menu"> Formations  </span></a></li>
